	...
	public WebMvcConfigurer corsConfigurer() {
		return new WebMvcConfigurer() {
			public void addCorsMappings(CorsRegistry registry) {
				...
				registry.addMapping("/jobInfo/getJobList").allowedOrigins("http://localhost:8081").allowCredentials(true);
				...
				registry.addMapping("/logout").allowedOrigins("http://localhost:8081").allowCredentials(true);
			}
		};
	}
